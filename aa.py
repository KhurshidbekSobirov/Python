...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("O'zbekcha X | 0")

        self.setGeometry(100, 10,300, 500)
    ...
    def UiComponents(self):
        ...
        reset_game = QPushButton("Qayta o'yin", self)
    ...
    def action_called(self):
        ...
        if win\
                == True:
            if self.turn == 0:
                text = "O G'olib bo'ldi!"
            else:
                text = "X G'olib bo'ldi!"
