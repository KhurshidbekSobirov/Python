...
class Window(QMainWindow):
	def __init__(self):
		...
		self.setWindowTitle("Xurshidbek003 ")
	...
	def UiComponents(self):
		...
		push_equal.setStyleSheet("background: dark gray")
		...
		push_plus.setStyleSheet("background: orange")

		push_minus = QPushButton("-", self)
		push_minus.setGeometry(275, 200, 80, 40)
		push_minus.setStyleSheet("background: orange")

		push_mul = QPushButton("*", self)
		push_mul.setGeometry(275, 150, 80, 40)
		push_mul.setStyleSheet("background: orange")


		push_div = QPushButton("/", self)
		push_div.setGeometry(185, 300, 80, 40)
		push_div.setStyleSheet("background: orange")
		...
		push_clear.setStyleSheet("background: dark gray;")

		push_del = QPushButton("Del", self)
		push_del.setGeometry(210, 100, 145, 40)
		push_del.setStyleSheet("background: dark gray")
